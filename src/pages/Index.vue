    ...
    <div v-if="p" class="wrapper py-8">
      ...
      <footer class="text-xs text-center pb-32 px-8">
        <div class="flex flex-wrap justify-center mb-32">
          <img class="logo opacity-80" src="/dolby.jpeg" alt="Dolby" width="670" height="377" />
          <img class="logo opacity-80" src="/ssds.png" alt="SSDS" width="200" height="164" />
          <img class="logo opacity-80" src="/mpaa.jpg" alt="MPAA" width="500" height="281" />
        </div>
